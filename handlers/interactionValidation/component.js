module.exports = (client, interaction) => {
	if (interaction.isButton()) {
		...
		if (!button.userOnly && interaction.user.id !== interaction.message.interaction.user.id) return [false,{ content: "Vous n'êtes pas originaire de cette commande !", ephemeral: true }]
